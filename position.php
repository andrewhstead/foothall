...
?>
	...
	<div class="page-template">
		...
		<?php
			...
			echo '<img class="position-diagram" alt="'.$position_name.'" src="img/positions/generic/'.strtolower(str_replace(' ','_',$position_name)).'.png" onclick="openBox(\'positions\', \'generic\', \''.strtolower(str_replace(' ','_',$position_name)).'\', \'png\')">';

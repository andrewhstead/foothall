		<form class="edit-form" method="post" action="edit_record.php?type=matches&code=<?php echo $record_id; ?>">
			...
			<div class="flex-wrapper">
				...
				<div class="flex-item form-section">
					...
					<input type="text" name="score-1" placeholder="0" id="score-1" value="<?php echo $score_1; ?>" size="1">
					<br>
					...
					<input type="text" name="score-2" placeholder="0" id="score-2" value="<?php echo $score_2; ?>" size="1">
